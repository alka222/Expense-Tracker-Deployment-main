    ...
    try {
      ...
      tranEmailApi
        .sendTransacEmail({
          ...
          htmlContent: `Click on the link below to reset password <br> <a href="http://${process.env.SERVER_IP}:3000/password/resetpassword/${forgotPasswordRecord.id}">Reset password</a>`,
        })
        .then((response) => {
